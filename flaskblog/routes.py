...
def home():
    ...
    posts = Post.query.paginate(page=page, per_page=5)  # grab all posts
...
#  showing posts for specific username
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('Email has been sent with password reset instructions.', 'info')
        return redirect(url_for('login'))
